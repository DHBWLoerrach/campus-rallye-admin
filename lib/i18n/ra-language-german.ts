...
const germanMessages: TranslationMessages = {
  ra: {
    ...
    message: {
      ...
      clear_array_input:
        'Möchten Sie die gesamte Liste wirklich löschen?',
    },
    navigation: {
      no_filtered_results: 'Keine gefilterten Ergebnisse gefunden',
    ...
    validation: {
      ...
      regex:
        'Muss dem folgenden regulären Ausdruck entsprechen: %{pattern}',
    },
    sort: {
